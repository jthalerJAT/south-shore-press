...
export const FRONT_PRINT_SPEC: PrintSpec = {
  ...
  elements: [
    // ── Header ──────────────────────────────────────────────
    { type: 'image', bounds: [36, 36, 720, 72], bind: 'logo_url', fit: 'contain' },
    { type: 'text', bounds: [36, 120, 260, 18], bind: 'year_issue', style: { font: BODY_FONT, fontStyle: 'Bold', size: 11, fill: BLACK } },
    { type: 'text', bounds: [296, 120, 200, 18], bind: 'tagline', style: { font: BODY_FONT, fontStyle: 'Italic', size: 11, align: 'center', fill: BLACK } },
    { type: 'text', bounds: [496, 120, 260, 18], bind: 'issue_date', style: { font: BODY_FONT, fontStyle: 'Bold', size: 11, align: 'right', uppercase: true, fill: BLACK } },
    { type: 'rect', bounds: [36, 150, 720, 2], style: { fill: BLACK } },

    // ── Hero ────────────────────────────────────────────────
    { type: 'image', bounds: [36, 156, 720, 696], bind: 'hero.photo_url', fit: 'fill' },
  ...
  tiles: {
    ...
    regionFill: SSP_BLUE,
    template: [
      { type: 'image', bounds: [0, 6, 0, 90], bind: 'photo_url', fit: 'fill' },
      { type: 'rect', bounds: [4, 9, 74, 16], bind: 'section_label', skipIfEmpty: true, style: { fill: NAVY } },
      { type: 'text', bounds: [8, 10, 70, 14], bind: 'section_label', skipIfEmpty: true, style: { font: HEADLINE_FONT, fontStyle: 'Bold', size: 9, fill: WHITE, uppercase: true } },
      { type: 'text', bounds: [4, 90, -8, 12], bind: 'credit', prefix: 'Credit: ', skipIfEmpty: true, style: { font: BODY_FONT, size: 8, fill: WHITE } },
      { type: 'text', bounds: [4, 102, -8, 48], bind: 'headline', skipIfEmpty: true, style: { font: HEADLINE_FONT, fontStyle: 'Bold', size: 15, leading: 15, fill: WHITE } },
      { type: 'text', bounds: [4, 150, -8, 12], bind: 'page_ref', prefix: 'Story on pg. ', skipIfEmpty: true, style: { font: HEADLINE_FONT, fontStyle: 'Bold', size: 10, align: 'right', fill: WHITE } },
    ],
  },
};
